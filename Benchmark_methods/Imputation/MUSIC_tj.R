...
data<-read.csv("/home/liuyan/code/singlecell/MUSIC-GCN/MUSIC_imputation.csv",header = FALSE)
...
ciliated_genes <- c("che-1",
                    ...
                    "ceh-36",
                    "ham-1")
pdf("./MUSIC_single_genes.pdf",width = 8.27,height = 8.27)
plot_cells(cds,
...
cds <- learn_graph(cds)
pdf("./MUSIC_celltype.pdf",width = 8.27,height = 8.27)
plot_cells(cds,
           ...
           graph_label_size=3)
dev.off()
pdf("./MUSIC_embryo.time.bin.pdf",width = 8.27,height = 8.27)
plot_cells(cds,
