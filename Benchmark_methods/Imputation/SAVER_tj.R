...
data<-read.csv("/home/liuyan/code/singlecell/MUSIC-GCN/trj/packer_saver.csv", header=TRUE, row.names=1)
...
ciliated_genes <- c("che-1",
                    ...
                    "ceh-36",
                    "ham-1")
pdf("./saver_single_genes.pdf",width = 8.27,height = 8.27)
plot_cells(cds,
...
cds <- learn_graph(cds)
pdf("./saver_celltype.pdf",width = 8.27,height = 8.27)
plot_cells(cds,
           ...
           graph_label_size=3)
dev.off()
pdf("./saver_embryo.time.bin.pdf",width = 8.27,height = 8.27)
plot_cells(cds,
